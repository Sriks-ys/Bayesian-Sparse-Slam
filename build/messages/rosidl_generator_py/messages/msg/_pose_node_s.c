...
bool messages__msg__pose_node__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("messages.msg._pose_node.PoseNode", full_classname_dest, 32) == 0);
  }
  messages__msg__PoseNode * ros_message = _ros_message;
  {  // id
...
{
  /* NOTE(esteve): Call constructor of PoseNode */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("messages.msg._pose_node");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PoseNode");
