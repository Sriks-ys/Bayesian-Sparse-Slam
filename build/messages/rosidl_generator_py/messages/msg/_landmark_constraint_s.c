...
bool messages__msg__landmark_constraint__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("messages.msg._landmark_constraint.LandmarkConstraint", full_classname_dest, 52) == 0);
  }
  messages__msg__LandmarkConstraint * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of LandmarkConstraint */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("messages.msg._landmark_constraint");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "LandmarkConstraint");
