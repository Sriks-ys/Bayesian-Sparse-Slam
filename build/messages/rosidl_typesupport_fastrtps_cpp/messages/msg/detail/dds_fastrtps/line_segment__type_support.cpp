...
#include "messages/msg/detail/line_segment__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const messages::msg::LineSegment & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  messages::msg::LineSegment & ros_message)
{
  // Member: rho
  cdr >> ros_message.rho;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = messages::msg::LineSegment;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const messages::msg::LineSegment *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<messages::msg::LineSegment *>(
    untyped_ros_message);
...
{
  return &messages::msg::typesupport_fastrtps_cpp::_LineSegment__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, messages, msg, LineSegment)() {
  return &messages::msg::typesupport_fastrtps_cpp::_LineSegment__handle;
}
